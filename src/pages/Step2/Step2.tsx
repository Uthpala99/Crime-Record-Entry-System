...
export function Step2() {
  ...
  const handleLatitudeTextChange = (event:  React.ChangeEvent<HTMLInputElement>) => {
    setLatitude(event.target.value);
  };
  
  const handleLongitudeTextChange = (event:  React.ChangeEvent<HTMLInputElement>) => {
    setLongitude(event.target.value);
  };

  const handleCrimeLocationAddrTextChange = (event:  React.ChangeEvent<HTMLInputElement>) => {
  ...
  return (
    <BaseBox>
      <div className="p-5 flex flex-col grow">
        <span className="text-xl font-bold">2. අපරාධ ස්ථානයේ නිලධාරී වසම සහ ලිපිනය</span>
            ...
            <div>
                <div className="mt-3">
                  ...
                  <SelectInput
                    ...
                    items={["කම්මල්තුර", "උතුරු පල්ලන්සේන", "කොච්චිකඩේ", "මට්ටක්කුලිය", "කොටහේන නැගෙනහිර", 
                      "මාලිගාවත්ත නැගෙනහිර" , "ඛෙත්තාරාම" , "අළුත්කඩේ නැගෙනහිර", "නිව් බසාර්", "කොම්පඤ්ඤ වීදිය", "කෙසෙල්වත්ත"]}
                  />
                </div>
